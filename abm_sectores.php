...
<table class= "table" width="100%" bordercolor=#81B077 border="2" align="center">
	...
	<form>
	 <a href="AltaSectores.php">
    <button type="button" class="btn btn-primary">ALTA SECTOR</button>
	 </a>	
	...
	<tbody>
          ...
          <tr>
              ...
              <td>
                  ...
                  <a href="AltaSectores.php?cod_sector=<?php echo $filas['cod_sector']?>"></a>
                  <a href="BajaSector.php?cod_sector=<?php echo $filas['cod_sector']?>" class="btn btn-primary">Eliminar</a>
				  <a href="ModifSector1.php?cod_sector=<?php echo $filas['cod_sector']?>" class="btn btn-primary">Modificar</a>
              </td>
